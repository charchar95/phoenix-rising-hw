...
// console.log(panagrams.map(word => word.toUpperCase))
//  got lost in this one. I couldn't out why this didn't work. I also tried: 
// console.log(panagrams.map(panagrams.toUpperCase))
